    ...
    <>
      <div id="main-container" className="h-screen w-screen">
        ...
        <div className="flex justify-center items-center w-full">
          <div id="content-container" className="content flex flex-col md:flex-row justify-center items-center lg:p-10 mb-20 mt-40  lg:px-10 shadow-md bg-white  border-[0.5px] border-slate-200 rounded-md gap-8 font-Poppins w-10/12">
            <div id="image-container" className="flex justify-center h-full md:h-[25rem] items-center border-2 border-slate-100 rounded-md shadow-md w-full md:w-1/2 overflow-hidden">
              <img id="product-image" src={`${detail?.gambar}`} className="w-full h-full  rounded-md" />
            </div>
